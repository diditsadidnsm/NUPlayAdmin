...
export class Dashboard extends Component {
  ...
  getDataApi = () => {
    axios.get("https://api.pray.zone/v2/times/today.json?city=paris")
        ...
        <div className="proBanner">
          <div>
            <span className="d-flex align-items-center purchase-popup">
              <p>وَالْعَصْرِ (1) إِنَّ الْإِنْسَانَ لَفِي خُسْرٍ (2) إِلَّا الَّذِينَ آَمَنُوا وَعَمِلُوا الصَّالِحَاتِ وَتَوَاصَوْا بِالْحَقِّ وَتَوَاصَوْا بِالصَّبْرِ (3) (QS. Al ‘Ashr)</p>
              <a href="!#" rel="noopener noreferrer" className="btn btn-sm purchase-button ml-auto">بِسْمِ اللّهِ الرَّحْمَنِ الرَّحِيْ</a>
              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    <h4 className="mb-1 mb-sm-0">Jangan lupa untuk melaksanakan ibadah sholat</h4>
                    <p className="mb-0 font-weight-normal d-none d-sm-block">“Maka celakalah bagi orang-orang yang shalat, (yaitu) orang yang lalai dari shalatnya”. (QS, al-Maun: 4-5)</p>
                  </div>
                  <div className="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                    <button className="btn btn-outline-light btn-rounded get-started-btn">أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمِ</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-12 grid-margin">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Jadwal Sholat</h4>
